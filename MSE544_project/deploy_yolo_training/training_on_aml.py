...
# Make a temporary directory and mount mos2 image dataset
...
dataset = Dataset.get_by_name(ws, name='mos2_image_yolov5')
print("Download dataset")
dataset.download(mounted_path,overwrite=True)
print("Check that the tar file is there:")
print(os.listdir(mounted_path))
print("mos2_images dataset download done")
...
print("")
print("Content of the mos2_images folder:")
mos2_images_folder = os.path.join(".","mos2_images")
print(os.listdir(mos2_images_folder))
...
with open(yolo_yaml, 'w') as yamlout:
    yaml.dump(
        {'train': os.path.join('../mos2_images','train'),
        'val': os.path.join('../mos2_images','val'),
        'nc': len(tags),
        'names': tags},
        yamlout,
...
os.system('python yolov5/train.py --img 640 --batch 4 --epochs 100 --data ./mos2_defect_detection_yolov5.yaml --weights yolov5s.pt')

os.system('python yolov5/detect.py --weights ./yolov5/runs/train/exp/weights/best.pt --iou 0.05 --save-txt --source ./mos2_images/test/images/')
